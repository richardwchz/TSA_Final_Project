...
```{r}
merged_ts <- ts(c(ts_EU_price_shorten_200409_202203,ts_consumption),               
   start = start(ts_EU_price_shorten_200409_202203),
   frequency = frequency(ts_EU_price_shorten_200409_202203))
merged_ts
...
checkresiduals(ts_EU_price_shorten_201407_202101)
```
