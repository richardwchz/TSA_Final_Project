...
```
```{r}
df_cor<-cbind(EU_price$Price,EU_GDP$GDP,Consumption$Consumption,Import$Import)
head(df_cor)
cor(df_cor)
```
...
```{r}
ts_EU_price_shorten_201407_202101 <- ts(EU_price$Price[295:372],frequency=12,start=c(2014,07))
